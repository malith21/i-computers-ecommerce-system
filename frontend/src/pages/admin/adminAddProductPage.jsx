...
export default function AdminAddProductPage() {
    ...
    async function handleSave(){
        try{
            ...
            if(token == null){
                toast.error("you must logged to perform this action.")
            ...
            navigate("/admin/products");
             ...
             console.log("error respond data",error?.response);
             toast.error(error?.response?.data?.message ||"filed to add products. pls tey again.")
    ...
    return (
        <div className="w-full h-full flex flex-col flex items-center p-4 overflow-y-scroll" >
            <div className="sticky top-0 w-full h-[100px] rounded-lg bg-accent text-white flex items-center p-5 justify-between shadow-2xl">
                ...
                <div className=" h-full  flex justify-center items-center ">
                    ...
                    <button className="ml-4 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">Cancel</button>
               </div>
            </div>
            <div className= "w-full flex flex-wrap bg-white shadow-2xl p-5 mt-8 rounded-lg">
                ...
                <div className="w-1/4   p-2 ">
                    <label className="block mb-2 font-semibold">Availavility</label>
                    <select 
                        value={isAvailable}
                        onChange={
                        (e)=>{setIsAvailable(e.target.value ==="true")}
                        }className="border border-gray-300 rounded-md p-2 w-full ">
